...
async function buscarDetalhesShipment(conta, shipmentId) {
  if (!shipmentId) return { logisticType: null, status: null, estado: null, cidade: null, coletado_em: null, entregue_em: null };
  try {
    const accessToken = await getMLAccessToken(conta);
    ...
    return { logisticType: null, status: null, estado: null, cidade: null, coletado_em: null, entregue_em: null };
  }
}
