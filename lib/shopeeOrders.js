...
function montarPedidoGenericoShopee(loja, pedido) {
  ...
  return {
    ...
    // Prazo real do vendedor pra despachar (campo base da Shopee, não
    // precisa entrar em response_optional_fields) — usado no painel da TV
    // pra dar um cronômetro de verdade nesses pedidos, igual o Flex tem o
    // dele; sem isso, o card cairia no modo "sem prazo" (só mostra há
    // quanto tempo está parado, sem countdown).
